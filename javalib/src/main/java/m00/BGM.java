...
Say you have three workers: Jim, Steve & Allan. You need to have them clean the bathroom, sweep the floors & wash the windows. What\u2019s the best way to assign the jobs? First we need a matrix of the time it takes for each to do each job.
    Jim     Steve     Allan
Clean bathroom     1 hour     3 hours     3 hours
Sweep floors     2 hours     3 hours     3 hours
Wash windows     3 hours     3 hours     2 hours

Then the Hungarian algorithm, when applied to the above table would give us the shortest time it can be done in: Jim cleans the bathroom, Steve sweeps the floors and Allan washes the windows.
