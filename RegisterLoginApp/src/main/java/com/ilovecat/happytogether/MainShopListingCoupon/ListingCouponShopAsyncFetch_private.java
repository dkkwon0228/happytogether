 ...
 */
public class ListingCouponShopAsyncFetch_private extends AsyncTask<String, String, String> {
  ...
  protected String doInBackground(String... params) {
    ...
    try {
      ...
      String param = "COUPONOPENSTATE=" + "N";
  ...
  protected void onPostExecute(String result) {
    ...
    if (result.equals("no rows")) {
      ...
      try {
        ...
        MainCouponShopFragment.strArrDataCouponImageUrl_private = dataListCouponImageUrl.toArray(new String[dataListCouponImageUrl.size()]);
        MainCouponShopFragment.strArrDataCouponTitle_private = dataListCouponTitle.toArray(new String[dataListCouponTitle.size()]);
        MainCouponShopFragment.strArrDataCouponNotice1_private = dataListCouponNotice1.toArray(new String[dataListCouponNotice1.size()]);


        MainCouponShopFragment.prepareAlbums_private();
